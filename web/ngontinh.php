...
// Truy vấn lấy danh sách truyện thuộc thể loại Ngôn tình
$query = "SELECT truyen.*, theloai.name 
          FROM truyen 
          JOIN theloai ON truyen.idtheloai = theloai.idtheloai
          WHERE theloai.name = 'Ngôn tình'"; 
...
<head>
    ...
    <title>Truyện Ngôn Tình - Truyện Hay TT</title>
...
<div class="logo">
    ...
    <main>
        <h1>Danh sách Truyện Ngôn Tình</h1>
