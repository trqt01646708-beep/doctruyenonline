...
// Truy vấn lấy danh sách truyện thuộc thể loại Hệ thống
$query = "SELECT truyen.*, theloai.name 
          FROM truyen 
          JOIN theloai ON truyen.idtheloai = theloai.idtheloai
          WHERE theloai.name = 'Hệ thống'"; // Sử dụng dấu hỏi chấm thay vì 'Hệ thống' trực tiếp
// Thực thi truy vấn
...
<head>
    ...
    <title>Truyện Hệ Thống - Truyện Hay TT</title>
...
<main>
    <h1>Danh sách Truyện Hệ Thống</h1>
