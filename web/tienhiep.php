...
// Lấy danh sách truyện thuộc thể loại Tiên Hiệp
$query = "SELECT truyen.*, theloai.name FROM truyen 
          JOIN theloai ON truyen.idtheloai = theloai.idtheloai
          WHERE theloai.name = 'Tiên Hiệp'"; 
...
<head>
    ...
    <title>Truyện Tiên Hiệp - Truyện Hay TT</title>
...
<div class="logo">
    ...
    <main>
        <h1>Danh sách Truyện Tiên Hiệp</h1>
