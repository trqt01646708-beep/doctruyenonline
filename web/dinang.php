...
$query_theloai = "SELECT idtheloai AS id, name FROM theloai";
...
<head>
    ...
    <title>Truyện Dị Năng - Truyện Hay TT</title>
...
<div class="logo">
    ...
    <main>
        <h1>Danh sách Truyện Dị Năng</h1>
